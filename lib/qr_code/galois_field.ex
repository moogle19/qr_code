defmodule QRCode.GaloisField do
  ...
  @reverse_gf_table Map.new(@gf_table, fn {k, v} -> {v, k} end)

  @compile {:inline, to_i: 1, to_a: 1}
  ...
  def to_i(alpha) when alpha in 0..254, do: Map.fetch!(@reverse_gf_table, alpha)
  ...
  def to_a(integer) when integer in 1..255, do: Map.fetch!(@gf_table, integer)
